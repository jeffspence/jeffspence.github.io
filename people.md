...
<br>
<br>
Zefan is in the [Health Data Science](https://epibiostat.ucsf.edu/masters-degree-health-data-science) Master's program
and is working on developing tools to make it easier to use population genetic information
in genomic and protein language models.
<br>
<br>
<br>
<br>
...
Note that admissions are handled by separate
admissions committees, and so individual faculty do
not have influence over the admissions process.
